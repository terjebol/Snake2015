...
/**
 * Created by Terje on 12.02.2015.
 */
public class BlackMatterParticles {
    ...
    private static class BlackMatterBlender implements IBlendParticles {
        ...
        public void applyBlendFunc() {
            GL11.glBlendFunc(GL11.GL_ZERO, GL11.GL_ONE_MINUS_SRC_COLOR); //Special blend mode for Black particles
        }
    }

    private static class BlackMatterUpdater extends DefaultParticleSet.DefaultParticleUpdater {
